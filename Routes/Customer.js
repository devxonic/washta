...
router.get('/Shop', CustomerControllers.getAllShops)
router.get('/NearShop', CustomerControllers.getShopByLocation)
router.get('/Shop/:id', CustomerControllers.getShopById)
